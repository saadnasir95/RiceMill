    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ledgers", x => new { x.LedgerType, x.TransactionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BiltyNumber = table.Column<string>(nullable: true),
                    ProductId = table.Column<int>(nullable: false),
                    BagQuantity = table.Column<double>(nullable: false),
                    BagWeight = table.Column<double>(nullable: false),
                    KandaWeight = table.Column<double>(nullable: false),
                    TotalMaund = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GatePasses_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BagQuantity = table.Column<double>(nullable: false),
                    BagWeight = table.Column<double>(nullable: false),
                    ExpectedBagWeight = table.Column<double>(nullable: false),
                    TotalExpectedBagWeight = table.Column<double>(nullable: false),
                    KandaWeight = table.Column<double>(nullable: false),
                    ExpectedEmptyBagWeight = table.Column<double>(nullable: false),
                    TotalExpectedEmptyBagWeight = table.Column<double>(nullable: false),
                    Vibration = table.Column<double>(nullable: false),
                    TotalActualBagWeight = table.Column<double>(nullable: false),
                    ActualBagWeight = table.Column<double>(nullable: false),
                    ActualBags = table.Column<double>(nullable: false),
                    TotalMaund = table.Column<double>(nullable: false),
                    ProductId = table.Column<int>(nullable: false),
                    RatePerKg = table.Column<double>(nullable: false),
                    RatePerMaund = table.Column<double>(nullable: false),
                    TotalPrice = table.Column<double>(nullable: false),
                    Commission = table.Column<double>(nullable: false),
                    PercentCommission = table.Column<double>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BagQuantity = table.Column<int>(nullable: false),
                    Rate = table.Column<double>(nullable: false),
                    Total = table.Column<double>(nullable: false),
                    AddPrice = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Charges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Charges_Purchases_PurchaseId",
                        column: x => x.PurchaseId,
                        principalTable: "Purchases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Charges_Sales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Charges_PurchaseId",
                table: "Charges",
                column: "PurchaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Charges_SaleId",
                table: "Charges",
                column: "SaleId");
