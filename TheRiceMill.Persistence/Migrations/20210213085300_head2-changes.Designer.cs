...
namespace TheRiceMill.Persistence.Migrations
{
    ...
    [Migration("20210213085300_head2-changes")]
    partial class head2changes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head2", b =>
                {
                    b.HasOne("TheRiceMill.Domain.Entities.Head1", "Head1")
                        .WithMany("Head2")
                        .HasForeignKey("Head1Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head3", b =>
                {
                    b.HasOne("TheRiceMill.Domain.Entities.Head2", "Head2")
                        .WithMany("Head3")
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head4", b =>
                {
                    b.HasOne("TheRiceMill.Domain.Entities.Head3", "Head3")
                        .WithMany("Head4")
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head5", b =>
                {
                    b.HasOne("TheRiceMill.Domain.Entities.Head4", "Head4")
                        .WithMany("Head5")
