...
namespace TheRiceMill.Persistence.Migrations
{
    ...
    [Migration("20201227120717_added-heads-entities")]
    partial class addedheadsentities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.GatePass", b =>
                {
                    ...
                    b.HasIndex("LotId", "LotYear", "CompanyId");

                    b.ToTable("GatePasses");
                });

            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head1", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head2", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head3", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head4", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head5", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Lot", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.ProcessedMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<bool>("IsProcessedMaterial");
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.RateCost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<double>("BardanaAndMisc");
                    ...
                    b.Property<double>("LabourUnloadingAndLoading");

                    b.Property<int>("LotId");

                    b.Property<int>("LotYear");

                    b.Property<double>("ProcessingExpense");

                    b.Property<double>("PurchaseBrokery");

                    b.Property<double>("RatePer40LessByProduct");

                    b.Property<double>("RatePer40WithoutProcessing");

                    b.Property<double>("SaleBrockery");
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.StockIn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime>("GatepassTime");
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.StockOut", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.Voucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.VoucherDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.GatePass", b =>
                {
                    ...
                    b.HasOne("TheRiceMill.Domain.Entities.Lot", "Lot")
                        .WithMany("GatePasses")
                        .HasForeignKey("LotId", "LotYear", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head1", b =>
                {
                    b.HasOne("TheRiceMill.Domain.Entities.Head2")
                        .WithMany("Head1")
                        .HasForeignKey("Head2Id");
                });

            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head2", b =>
                {
                    b.HasOne("TheRiceMill.Domain.Entities.Head3")
                        .WithMany("Head2")
                        .HasForeignKey("Head3Id");
                });

            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head3", b =>
                {
                    b.HasOne("TheRiceMill.Domain.Entities.Head4")
                        .WithMany("Head3")
                        .HasForeignKey("Head4Id");
                });

            modelBuilder.Entity("TheRiceMill.Domain.Entities.Head4", b =>
                {
                    b.HasOne("TheRiceMill.Domain.Entities.Head5")
                        .WithMany("Head4")
                        .HasForeignKey("Head5Id");
                });
            ...
            modelBuilder.Entity("TheRiceMill.Domain.Entities.VoucherDetail", b =>
                {
                    ...
                    b.HasOne("TheRiceMill.Domain.Entities.Voucher", "Voucher")
                        .WithMany()
