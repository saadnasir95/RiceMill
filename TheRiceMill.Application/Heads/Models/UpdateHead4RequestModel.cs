...
{
    public class UpdateHead4RequestModel : IRequest<ResponseViewModel>
    {
    ...
    public class UpdateHead4RequestModelValidator : AbstractValidator<UpdateHead4RequestModel>
    {
        public UpdateHead4RequestModelValidator()
        {
